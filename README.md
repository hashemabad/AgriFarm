...
| ![آگریفارم](frontend/public/screenshots/AgriFarm.PNG) |  آگریفارمم (AgriFarm)سامانه تصمیم یار هوشمند مدیریت منابع کشاورزی برای بهینه سازی مصرف آب و انرژی با هدف حمایت از احیای اکوسیستم دریاچه ارومیه   |
|--------------------------------------------------------|--------------------------------------------------------|
